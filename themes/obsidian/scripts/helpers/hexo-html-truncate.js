...
var cheerio = require('../libs/cheerio/cheerio');
 ...
 * @return {String}
 */
var htmlTruncate = function (html, length, options) {
...
htmlTruncate.setup = function (options) {
...
hexo.extend.helper.register('htmlTruncate', function (content, length = 30, options = {}) {
    return htmlTruncate(content, length, options);
});